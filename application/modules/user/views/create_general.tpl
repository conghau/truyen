...
<div class="static_all_wrap">
	...
	{$fixed_base_url|cat:'user/confirm_create'|form_open:'enctype=multipart/form-data class=form-horizontal id=form_main autocomplete =off'}
		<table class="mem_input">
			...
			<tr>
				...
				<td>
					...
					<select name="txt_year" id="txt_year" class="txt_width90" >
						<option disabled value="0"{if $txt_year == ''} selected{/if}>{'label_placeholder_year'|lang}</option>
					...
					<select name="txt_month" id="txt_month" class="txt_width90">
						<option disabled value="0"{if $txt_month == ''} selected{/if}>{'label_placeholder_month'|lang}</option>
						{while $count <=  12 }
					...
					<select name="txt_day" id="txt_day" class="txt_width90">
						<option disabled value="0"{if $h_txt_day == ''} selected{/if}>{'label_placeholder_day'|lang}</option>
					</select>
			...
			<!-- author -->
			<tr>
				<th><label for="auth_method" class="control-label">{'label_user_auth_method'|lang}</label></th>
				<td>
			...
			<tr class="auth hide" id="auth_{$list_auth_method['auth_image']['id']}">
				...
				<td>
					...
					<input type="hidden" name="auth_method_image_session" value="{$client_name|h}" />
				</td>
			</tr>
			<tr class="auth hide" id="auth_{$list_auth_method['auth_info']['id']}">
				...
				<td>
					...
					<input type="text" class="clear txt" name="confirm_organization" value="{$confirm_organization|h}" maxlength="255"/><br>
					<br>
					<p>{'label_user_confirm_phone_number'|lang}</p>
					{form_error('confirm_phone_number','<p class="alert-error"> ※ ','</p>')}
					<input type="text" class="clear txt_width60 number" id="txt_phone1" value="{$txt_phone1|h}" maxlength="3"> -
					<input type="text" class="clear txt_width60 number" id="txt_phone2" value="{$txt_phone2|h}" maxlength="4"> -
					<input type="text" class="clear txt_width60 number" id="txt_phone3" value="{$txt_phone3|h}" maxlength="4">
					<input type="hidden" name="confirm_phone_number" value="{$confirm_phone_number}" id="txt_phone" maxlength="20">
