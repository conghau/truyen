...
{if isset($controller) && $controller == 'login'}
	<div class="login">
		<div class="ct mtb20">
			<a href="{$fixed_base_url}"><img src="{$fixed_base_url}assets_sp/img/{$language}/login_logo.png" width="90%"></a>
		</div>
	</div>
...
{literal}
	<!-- <script type="text/javascript" src="{/literal}{$fixed_base_url}assets_sp/js/jquery.pageslide.min.js{literal}"></script> -->
