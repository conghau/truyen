...
<div class="modalBase">
	...
	<div class="modalWrap">
		<div class="modal">
			...
			<div class="ctinner_m" style="display:none; width: 400px;" id="open_withdraw_dialog">
...
<div id="tab1" class="isTab">
	<div class="set_tabinner">
		<div class="ct">
			<input type="image" src="{$fixed_base_url}assets/img/{$language}/btn_set_save.png" class= "btn_save_edit btn-disabled"  style="border:none" disabled>
		</div>	
		...
		<div class="alignR">
			<input type="image" src="{$fixed_base_url}assets/img/{$language}/dakkai.png" class="btn-open-withdraw" style="border:none">
		</div>
	</div>
</div>
<div id="tab2" class="isTab" style="display: none;">
	<div class="set_tabinner">
		<div class="ct">
			<input type="image" src="{$fixed_base_url}assets/img/{$language}/btn_set_save.png" class= "btn_save_setting btn-disabled"  style="border:none" disabled>
		</div>
