	...
	<table class="inq">
		...
		<tr>
			<td>
				...
				{if $is_mail_wait_active eq TRUE}
					<input type="email" class="txt-disabled" name="email" id="email" size="30" value="{set_value(email,$user_info_edit['email'])}" readonly>
				{else}
		...
		<tr>
			<td>
				...
				<p class="upper_first_letter red">※{sprintf(('label_only_if_change_password'|lang),'')}</p>
			</td>
		</tr>
		<!-- re-password -->
		<tr>
		...
		<tr>
			<td>{form_error('birthday','<p class="alert-error"> ※ ','</p>')}
				...
				<select name="txt_year" id="txt_year" class="check txt_width90" style="margin-right : 0">
				...
				{$count =1}
				<select name="txt_month" id="txt_month" class="check txt_width90" style="margin-right : 0">
					{while $count <=  12 }
						<option value="{$count}">{$count}</option>
						{$count = $count + 1}
					{/while}
				</select>
				<select name="txt_day" id="txt_day" class="check txt_width90" style="margin-right : 0">
				</select>
		...
		<tr>
			<td>
				...
				<input type="hidden" name="qualification" id="txt_qualification" value="" maxlength="255">
			</td>
		</tr>
		...
		<tr>
			<th>
				<label for="domain" class="control-label">{'label_user_domain'|lang}</label>
			</th>
		</tr>
		<tr>
			<td>
				...
				{if $user_info_edit['domain_flag'] eq $list_profile_status['1']['id']}
					<p class="alignR"><input type="checkbox" class="toggle" id="domain_flag" checked/></p>
				{else}
					<p class="alignR"><input type="checkbox" class="toggle" id="domain_flag" /></p>
				{/if}
		...
		<tr>
			<th>
				<label for="specialist" class="control-label">{'label_user_specialist'|lang}</label>
			</th>
		</tr>
		<tr>
			<td>
				...
				{if $user_info_edit['specialist_flag'] eq $list_profile_status['1']['id']}
					<p class="alignR"><input type="checkbox" class="toggle" id="specialist_flag" checked/></p>
				{else}
					<p class="alignR"><input type="checkbox" class="toggle" id="specialist_flag" /></p>
				{/if}
			</td>
		</tr>
		<!-- history -->
		<tr>
			<th>
				<label for="history" class="control-label">{'label_user_history'|lang}</label>
			</th>
		</tr>
		<tr>
			<td>
				...
				{if $user_info_edit['history_flag'] eq $list_profile_status['1']['id']}
					<p class="alignR"><input type="checkbox" class="toggle" id="history_flag" checked/></p>
				{else}
					<p class="alignR"><input type="checkbox" class="toggle" id="history_flag" /></p>
				{/if}
			</td>
		</tr>
		<!-- university -->
		<tr>
			<th>
				<label for="university" class="control-label">{'label_user_university'|lang}</label>
			</th>
		</tr>
		<tr>
			<td>
				...
				{if $user_info_edit['university_flag'] eq $list_profile_status['1']['id']}
					<p class="alignR"><input type="checkbox" class="toggle" id="university_flag" checked/></p>
				{else}
					<p class="alignR"><input type="checkbox" class="toggle" id="university_flag" /></p>
				{/if}
			</td>
		</tr>
		...
		<tr>
			<th>
				<label for="scholar" class="control-label">{'label_user_scholar'|lang}</label>
			</th>
		</tr>
		<tr>
			<td>
				...
				{if $user_info_edit['scholar_flag'] eq $list_profile_status['1']['id']}
					<p class="alignR"><input type="checkbox" class="toggle" id="scholar_flag" checked/></p>
				{else}
					<p class="alignR"><input type="checkbox" class="toggle" id="scholar_flag" /></p>
				{/if}
			</td>
		</tr>
		...
		<tr>
			<th>
				<label for="author" class="control-label">{'label_user_author'|lang}</label>
			</th>
		</tr>
		<tr>
			<td>
				...
				{if $user_info_edit['author_flag'] eq $list_profile_status['1']['id']}
					<p class="alignR"><input type="checkbox" class="toggle" id="author_flag" checked/></p>
				{else}
					<p class="alignR"><input type="checkbox" class="toggle" id="author_flag" /></p>
				{/if}
			</td>
		</tr>
		<!-- society -->
		<tr>
			<th>
				<label for="society" class="control-label">{'label_user_society'|lang}</label>
			</th>
		</tr>
		<tr>
			<td>
				...
				{if $user_info_edit['society_flag'] eq $list_profile_status['1']['id']}
					<p class="alignR"><input type="checkbox" class="toggle" id="society_flag" checked/></p>
				{else}
					<p class="alignR"><input type="checkbox" class="toggle" id="society_flag" /></p>
				{/if}
			</td>
		</tr>
		<!-- hobby -->
		<tr>
			<th>
				<label for="hobby" class="control-label">{'label_user_hobby'|lang}</label>
			</td>
		</tr>
		<tr>
			<td>
				...
				{if $user_info_edit['hobby_flag'] eq $list_profile_status['1']['id']}
					<p class="alignR"><input type="checkbox" class="toggle" id="hobby_flag" checked/></p>
				{else}
					<p class="alignR"><input type="checkbox" class="toggle" id="hobby_flag" /></p>
				{/if}
			</td>
		</tr>
		<!-- message -->
		<tr>
			<th>
				<label for="message" class="control-label">{'label_user_message'|lang}</label>
			</td>
		</tr>
		<tr>
			<td>
				...
				{if $user_info_edit['message_flag'] eq $list_profile_status['1']['id']}
					<p class="alignR"><input type="checkbox" class="toggle" id="message_flag" checked/></p>
				{else}
					<p class="alignR"><input type="checkbox" class="toggle" id="message_flag" /></p>
				{/if}
			</td>
		</tr>
		<!-- language -->
			...
			$('.TinyTools').on('click', function(){
				...
				if($(h_id).val() != $('.'+id).val()){
					...
					if (ENABLE_EDIT) {
						...
						if(list.length == 0){
							ENABLE_EDIT = false;
							$('.btn_save_edit').addClass('disabled');
						};
					};
				};
			});
